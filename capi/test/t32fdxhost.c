 ...
 *
 *
 * $Id: t32fdxhost.c 96257 2018-04-27 08:00:11Z fsirl $
 * $LastChangedRevision: 96257 $
 * $LastChangedBy: fsirl $
 *
...
static int32_t GetMsecTimer(void)
{
	...
	return GetTickCount();
#elif defined(T32HOST_LINUX) || (defined(T32HOST_SOL) && defined(T32HOST_SOL_STUDIO12))
	uint64_t        t;
	...
	return (t / 1000);
#elif defined(T32HOST_SOL) && !defined(T32HOST_SOL_STUDIO12)
	return (int32_t) ((gethrtime()) / 1000000);
#else
